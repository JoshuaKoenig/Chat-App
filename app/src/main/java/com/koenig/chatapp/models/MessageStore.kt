...
interface MessageStore {
    ...
    fun receiveRecentMessagesForUser(currentUserId: String, message: MutableLiveData<MessageModel>)
    fun receiveRecentMessagesForGroup(currentGroupId: String, message: MutableLiveData<MessageModel>)
}